...
tab:
  ...
  title : "Schedule"
  content : |
    *Online talks will be broadcast live in room C-6070-9 (pav. Lionel-Groulx) via [**Jitsi**](https://meet.jit.si/anthological-navigations-crcen).  
    Collaborative notes are available [**here**](https://demo.hedgedoc.org/PNeQR0njRgmHglaidy_P5g#) (multilingual notes and important links).
  tablist:
  # tab item
  - name : "Day 01"
