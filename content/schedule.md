...
tab:
  ...
  title : "Calendrier"
  content : |
    *Les conférences en ligne seront retransmises en direct dans la salle C-6070-9 (pav. Lionel-Groulx) via [**Jitsi**](https://meet.jit.si/anthological-navigations-crcen).  
    Un pad collaboratif est à votre disposition [**ici**](https://demo.hedgedoc.org/PNeQR0njRgmHglaidy_P5g#) (notes multilingues et liens importants).
  tablist:
  # tab item
  - name : "Jour 01"
    ...
    - speaker : "Serena CANNAVALE (Università d degli Studi di Napoli Federico II)"
